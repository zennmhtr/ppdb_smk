                    ...
                    <table class="table table-striped" id="table-1">
                        <thead>
                            <tr style="text-align: center;">
                                ...
                                <th><b>Kode Jenis Daftar</b></th>
                                <th><b>Nama Jenis Daftar</b></th>
                                <th><b>Status</b></th>
                                <th><b>Action</b></th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            ?>
                                <tr style="text-align: center;">
                                    <td><b><?= $no; ?></b></td>
                                    <td><b><?= $jenis['id_jenis'] ?></b></td>
                                    <td><b><?= $jenis['nama_jenis'] ?></b></td>
                                    <td>
                                    ...
                                    <td>
                                        <button data-id="<?= $jenis['id_jenis'] ?>" class="hapus btn btn-danger"><i class="fas fa-trash"></i></button>
