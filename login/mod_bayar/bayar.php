    ...
    <?php if ($user['level'] == 'admin' or $user['level'] == 'bendahara' or $user['level'] == 'kepala') { ?>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4><b>DATA BELUM DIVERIFIKASI</b></h4>
                        <div class="card-header-action">
                            <a class="btn btn-primary" href="mod_bayar/export_bayar.php" role="button" class="btn btn-primary btn-sm"><i class="fas fa-print"></i> <b>Download Excel</b></a>
                        </div>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4><b>DATA SUDAH DIVERIFIKASI</b></h4>
                        <!-- <div class="card-header-action">
        ...
        <div class="col-12 col-sm-12 col-lg-12">
            <div class="card author-box card-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-sm" id="tablebayar" style="font-size: 12px">
                            <thead>
                                <tr>
                                    <th class="text-center">
                                        <b>No</b>
