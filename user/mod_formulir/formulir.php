<?php require "fungsi.php"; ?>
			 ...
			 <div class="alert alert-success alert-dismissable">
				...
				<b>TERIMA KASIH !!!</b><br />
				<b>DATA ANDA TELAH BERHASIL DITERIMA</b> <button class="badge badge-danger"> Dikonfirmasi Pada Tanggal  <?= $siswa['tgl_konfirmasi'] ?></button>
			</div>
			<div class="card-body">
		<div class="row">
		<div class="col-lg-4">
    ...
    <div class="col-12 col-sm-12 col-lg-12">
        <div class="card author-box card-primary">
            <div class="card-header">
                <h4><b>FORMULIR PENDAFTARAN SISWA BARU</b></h4>
            ...
            <div class="card-body">
                <div class="author-box-left">
                    <img alt="img" src="../<?= $siswa['foto'] ?>" class="rounded-circle author-box-picture">
                ...
                <div class="author-box-details">
                    ...
                    <ul class="nav nav-pills" id="myTab3" role="tablist">
                        ...
                        <li class="nav-item col-sm-12 col-md-2">
                            <a class="nav-link" id="contact-tab3" data-toggle="tab" href="#contact3" role="tab" aria-controls="contact" aria-selected="false"><i class="fas fa-home    "></i> <b>Data Alamat</b></a>
                        </li>
                        <li class="nav-item col-sm-12 col-md-2">
						 ...
						 <li class="nav-item col-sm-12 col-md-2">
                            <a class="nav-link" id="profile-tab3" data-toggle="tab" href="#foto3" role="tab" aria-controls="profile" aria-selected="false"><i class="fas fa-user-friends    "></i> <b>Upload Foto</b></a>
                        </li>
                        ...
                        <div class="tab-pane fade show active" id="home3" role="tabpanel" aria-labelledby="home-tab3">
                            <form id="form-datadiri">
                                ...
                                <div class="form-group">
                                    <br>
                                    <p><b>* Harap isi Data Diri dengan sebenar-benarnya</b></p>
