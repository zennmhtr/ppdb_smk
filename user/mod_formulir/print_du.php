...
<html>
	<head>
		<title>FORMULIR DAFTAR ULANG ( <?= $siswa['nama'] ?> )</title>
	</head>
	<body>
    ...
    <body>
        ...
        <hr>
		<center><b>FORMULIR DAFTAR ULANG PESERTA DIDIK BARU TAHUN 2024</b></center>
		<br>
		...
		<br>
            ...
            <tr>
				...
				<td style="text-align: center">
                    <font size="2">  
						<img class="img" src="../../<?= $siswa['foto'] ?>" ec="H" style="width: 30mm; height: 40mm; background-color: white; color: black;">
					</font>
                </td>
				<td><td><td><td><td><td>
...
$dompdf->render();
$dompdf->stream("PPDB2024_" . $siswa['nama'] . ".pdf", array("Attachment" => false));
exit(0);
?>